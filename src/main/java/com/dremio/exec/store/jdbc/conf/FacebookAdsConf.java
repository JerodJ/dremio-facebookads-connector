...
@SourceType(value = "FacebookAdsARP", label = "FacebookAds",uiConfig = "facebookads-layout.json")
public class FacebookAdsConf extends AbstractArpConf<FacebookAdsConf> {
  private static final String ARP_FILENAME = "arp/implementation/facebookads-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.facebookads.FacebookAdsDriver";
